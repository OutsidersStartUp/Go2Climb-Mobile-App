                  ...
                  Container(
                      ...
                      child: SingleChildScrollView(
                        child:
                          ...
                          sizedBox(),
                          const Text(
                            'Promociona tu servicio y llega a más personas. Los usuarios que promocionan sus servicios tienen una mayor relevancia al realizar una búsqueda.',
                          ...
                          Row(
                            children: const [
                              Spacer(),
                              Text(
                                "Costo diario por promoción: 5.00 USD",
...
Container priceForm() {
  var priceMask =
      MaskTextInputFormatter(mask: 'S/.####', filter: {"#": RegExp(r'[0-9]')});
  return Container(
    decoration: BoxDecoration(
        borderRadius: BorderRadius.circular(20),
        border: Border.all(color: GlobalVariables.primaryColor, width: 3)),
    ...
    child: SizedBox(
      ...
      keyboardType: TextInputType.number,
      decoration:
          const InputDecoration(border: InputBorder.none, hintText: "200 PEN"),
    )),
  );
}
...
Row dateForm(BuildContext context) {
  return Row(
    children: [
      SizedBox(
          width: MediaQuery.of(context).size.width * 0.4, child: _startDate()),
      SizedBox(
